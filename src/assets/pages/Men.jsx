  ...
  return (
    <>
      <div className="row p-3 ">
       {products.filter(v=>v.product=="men").map((v, i) => (
            ...
            <div className="card border-0 bg-transparent">
              ...
              <div className="card-body">
                <span className="badge  position-absolute love" ><img width="30" height="30" src="https://img.icons8.com/ios-filled/50/FA5252/like--v1.png" alt="like--v1"/></span>
                 <span className="badge  position-absolute love1" ><img width="30" height="30" src="https://img.icons8.com/ios-filled/50/737373/shopping-cart.png" alt="shopping-cart"/></span>
